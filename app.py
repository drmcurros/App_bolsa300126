    ...
    if tabla:
        ...
        st.dataframe(
            ...
            column_config={
                ...
                "Valor Actual": st.column_config.NumberColumn(format="%.2f €", help="Copia este valor en 'Importe Total' para vender todo"),
